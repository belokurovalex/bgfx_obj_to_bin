//// 50-obj_to_bin.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
////
//
//#include <iostream>
//
...
void help(const char* _error = NULL)
{
	...
	bx::printf(
		...
		"      --[l/r]h-up+[y/z]	  Coordinate system. Defaults to '--lh-up+y' вЂ” Left-Handed +Y is up.\n"
